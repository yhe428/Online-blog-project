...
INSERT INTO ArticlesSearch (articleId, title, content, authorfName, authorlName, categoryName, articleDate, imageName, imageHeight)
SELECT a.articleId, a.title, a.articleContent, u.fName, u.lName, c.name, a.articleDate, a.imageName, a.imageHeight
FROM Articles AS a
